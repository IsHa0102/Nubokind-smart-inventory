...
// ── Shipment products — dynamic variant architecture ───────────────────────
// Potli removed from Ele/Kiko fixedItems — it is now a standalone product.
// autoDeducts: packaging items deducted automatically when this product ships.
const SHIPMENT_PRODUCTS = [
  {
    ...
    image: "https://res.cloudinary.com/dgqcdiyad/image/upload/f_auto,q_auto/ele-teether-blue-beige__wljswi",
    variants: [
      { key: "sg_ab", label: "Sage Green + Aqua Blue",  colors: ["Ele Sage Green Teether", "Ele Aqua Blue Teether"] },
      { key: "bp_ob", label: "Baby Pink + Oat Beige",   colors: ["Ele Baby Pink Teether", "Ele Oat Beige Teether"] },
      { key: "sg_sg", label: "Sage Green + Slate Grey", colors: ["Ele Sage Green Teether", "Ele Slate Grey Teether"] },
      { key: "ab_ob", label: "Aqua Blue + Oat Beige",   colors: ["Ele Aqua Blue Teether", "Ele Oat Beige Teether"] },
      { key: "ab_bp", label: "Aqua Blue + Baby Pink",   colors: ["Ele Aqua Blue Teether", "Ele Baby Pink Teether"] },
      { key: "sg_ob", label: "Sage Green + Oat Beige",  colors: ["Ele Sage Green Teether", "Ele Oat Beige Teether"] },
      { key: "sg_bp", label: "Sage Green + Baby Pink",  colors: ["Ele Sage Green Teether", "Ele Baby Pink Teether"] },
    ],
    fixedItems: ["Ele Box"],
...
// Includes autoDeducts (Blue Box, Ribbon) so the backend receives the full list.
function buildLineDeductions(productKey, variantKey, qty) {
  const Q = Number(qty)
...
function buildAllDeductions(lines) {
  const map = {}
  lines.forEach((line) => {
